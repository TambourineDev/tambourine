/*
 * Last Updated By Silvana Ramirez | July 2018
 * Last updates: modular file, shortcodes, centralized tasks in lib/
 * Notes: By default we don't have critical css in Desktop 
*/
...
function reload(reload = 'browserSync'){
    ...
    const watchForReload = ['**/*.{php,tpl,html}', `./m/assets/critical.css`, `${shortcodePath}**/**.{css,js}`];
